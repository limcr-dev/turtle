			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-8 animate-box">
						<p class="fs-1">게시글 수정</p>
						<br>
						<form name="inputform" action="boardUpdateAction.bo" method="post">
							<div class="row g-3 align-items-center">
								<div class="col-md-1">
									<h5>제목</h5>
								</div>
								<div class="col-md-11">
									<input type="text" name="boardTitle" id="boardTitle" maxlength="33" value="${dto.boardTitle}" class="form-control form-control-lg" placeholder="제목을 입력하세요" required autofocus>
								</div>
							</div>
							<br>
	
							<div class="row form-group">
								<textarea name="boardContent" id="boardContent" cols="30" rows="10" class="form-control form-control-lg" placeholder="내용을 입력해주세요" required>${dto.boardContent}</textarea>
							</div>
							<br>
