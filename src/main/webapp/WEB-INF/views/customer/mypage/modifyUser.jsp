			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 animate-box">
						<p class="fs-1">회원 수정 비밀번호 인증</p>
						<br>
						<form name="passwordform" action="modifyUserDetail.do" method="post">
							...
							<div class="form-group" align="right">
								...
								<input type="reset" value="수정취소" class="btn btn-dark" onclick="window.location='main.do'">
							</div>
						</form>	
					</div>
					<div class="col-md-3">
