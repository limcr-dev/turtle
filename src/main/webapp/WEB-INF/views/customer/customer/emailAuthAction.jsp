    ...
    <script>
        ...
        window.onload = function(event){
            ...
            RFCBtn.onclick = function(e){
            	...
            	// 인증코드 발송 처리
                // 랜덤 인증 코드(6자리) 생성 
                const ResponseCode = Math.floor(Math.random() * 900000 + 100000);
            	...
            	(function() {
                    ...
                    emailjs.send("service_or095gz","template_1j62m25", {to_name:email_input.value, from_name: "seb.dev.it@gmail.com", message:ResponseCode});
                })();
...
<body class="container">
    ...
    <div class="email_container">
        ...
        <div class="email_box">
            ...
            <button class="RFCBtn">인증코드 발송</button>
        </div>
