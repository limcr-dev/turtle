					...
					<div class="col-md-8 animate-box">
						...
						<form name="inputform" action="joinAction.do" method="post"
							...
							<div class="row g-3 align-items-center">
								...
								<div class="col-md-10">
									<input type="text" id="userPw" name="userPw" class="form-control form-control-lg" placeholder="비밀번호를 입력하세요" required>
								</div>
							</div>
							<br>
							...
							<div class="row g-3 align-items-center">
								...
								<div class="col-md-10">
									<input type="text" id="r_userPw" name="r_userPw" class="form-control form-control-lg" placeholder="비밀번호 확인" required>
								</div>
							</div>
							<br>
							...
							<div class="row form-group">
								...
								<div class="col-md-10">
									<input type="text" id="address" name="address" class="form-control form-control-lg" name="roadFullAddr" >
								</div>
							</div>
							<p>
