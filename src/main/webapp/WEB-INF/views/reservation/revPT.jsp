...
<script src="${path}/resources/js/reservation/PTcalendar.js" defer></script>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-8 animate-box">
								<p class="fs-1">피티 예약</p>
								<br>
								<form name="revPTForm" action="revPTInsert.do" method="post"
									onsubmit="return revPTCheck()">
									...
									<input type="hidden" name="hiddenTrainerId" value="">
									...
									<div class="row g-3 align-items-center">
										...
										<div class="col-md-2">
											<input type="button" class="btn btn-secondary" name="userChk" value="회원인증" onclick="revPTCheckUser()">
										</div>
									</div>
									...
									<div class="row g-3 align-items-center">
										...
										<div class="col-md-10">
											<input type="text" id="trainerId" name="trainerId" class="form-control form-control-lg" disabled>
										</div>
									</div>
